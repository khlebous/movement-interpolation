...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        // - The one taking "bool selected_patch" as a read-only selection information. When Selectable() has been clicked is returns true and you can alter selection state accordingly.
...
// During this frame there will be a gap in the tab bar, and if the tab that has disappeared was the selected_patch one, the tab bar
// will report no selected_patch tab during the frame. This will effectively give the impression of a flicker for one frame.
