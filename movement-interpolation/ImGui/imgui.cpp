...
/*
 ...
 - 2015/06/14 (1.41) - changed Selectable() API from (label, selected_patch, size) to (label, selected_patch, flags, size). Size override should have been rarely be used. Sorry!
